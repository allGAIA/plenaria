...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light shadow p-lg-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav mr-auto py-0">
                        <a href="###" class="nav-item nav-link active">Ventas</a>
    ...
    <!-- Boton de agregar -->
    <div class="container">
        <h1 class="section-title position-relative text-center mb-5">Agregar nueva venta</h1>
        <div class="d-flex justify-content-evenly">
            <!-- BOTÓN MODAL **AGREGAR** -->
            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#agregarVenta">
            AGREGAR
            </button>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="staticBackdropLabel">Agregar nueva venta</h5>
                        ...
                        <div class="modal-body">
                            <div class="container-fluid row">
                                ...
                                <div>
                                    <label for="exampleInputEmail1" class="form-label">ID de Venta</label>
                                    <input type="text" class="form-control" id="ID_venta" name="ID_Venta">
                                </div>

                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">ID de paleta</label>
                                    <input type="number" class="form-control" id="ID_paleta" name="ID_paleta">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="Tipo_mov" name="Tipo_mov">
                                </div> 
                            </div>
            ...
            <!-- MODAL **EDITAR** -->
            <div class="modal fade" id="editarVenta" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <!-- MODAL **ELIMINAR** -->
            <div class="modal fade" id="eliminarVenta" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <th scope="row">1</th>
                            ...
                            <td>Venta</td>
                            <td>
                            <button type="button" class="btn btn-warning fa-solid fa-pen-to-square" data-bs-toggle="modal" data-bs-target="#editarVenta"></button>
                            <button type="button" class="btn btn-danger fa-solid fa-trash" data-bs-toggle="modal" data-bs-target="#eliminarVenta"></button>
                            </td>
                        </tr>
                    </tbody>
                </table>
